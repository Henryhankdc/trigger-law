...
export default class TexasCard extends Component {
        render() {
            return(
                <div className="mt-9 mb-3">
                    <div className='p-5'>
                        <h2 className="uppercase text-8xl text-center uppercase font-bold">yes.</h2>
                        <p className="capitalize text-center text-5xl mt-3 pt-8"><span className="underline decoration-solid">Texas</span> does have a trigger law.</p>
